      ...
      <LegalPageContainer>
        ...
        <LegalContent>
          ...
          <LegalSection>
            ...
            <LegalParagraph>
              When you make a payment for your call center order, the following may appear on your credit card or 
              bank statement:
            </LegalParagraph>
            <LegalList>
              <LegalListItem>
                <strong>Billing Descriptor:</strong> "{process.env.REACT_APP_COMPANY_NAME}" or "{process.env.REACT_APP_BRAND_NAME}"
              </LegalListItem>
              <LegalListItem>
