      ...
      <LegalPageContainer>
        ...
        <LegalContent>
          <LegalSection>
            ...
            <LegalParagraph>
              We serve only call center clients. These End-User Terms of Service ("End-User Terms") govern your use of services provided by 
              {process.env.REACT_APP_COMPANY_NAME} when you make a purchase through our call center offers.
            </LegalParagraph>
            <LegalParagraph>
          ...
          <LegalSection>
            ...
            <LegalParagraph>
              {process.env.REACT_APP_COMPANY_NAME} provides customer payment assistance services for call center purchases. 
              Our services include:
            </LegalParagraph>
            <LegalList>
              <LegalListItem>
                <strong>Payment Processing:</strong> Secure processing of payments for products ordered through call center
              </LegalListItem>
              <LegalListItem>
              ...
              <LegalListItem>
                <strong>Customer Service:</strong> Support for questions about your call center order
              </LegalListItem>
              <LegalListItem>
            ...
            <LegalParagraph style={{ marginTop: '1rem' }}>
              We process payments for products you ordered via call center. The products and services are provided 
          ...
          <LegalSection>
            ...
            <LegalParagraph>
              These End-User Terms are governed by the laws of the State of California, United States, without regard to 
            ...
            <LegalList>
              ...
              <LegalListItem>
                <strong>Arbitration Location:</strong> Arbitration shall take place in Sacramento, California or remotely by mutual agreement
              </LegalListItem>
              <LegalListItem>
