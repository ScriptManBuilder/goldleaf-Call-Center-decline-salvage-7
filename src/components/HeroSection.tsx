...
const HeroSection: React.FC = () => {
  const appSubdomain = process.env.REACT_APP_DOMAIN || 'goldleafcallcenter.com';
  ...
  return (
    <HeroContainer>
      <HeroContent>
        ...
        <Tagline>We specialize in serving merchants who acquire customers through <strong style={{color: '#A78BFA'}}>call center operations</strong>. Our decline recovery technology is optimized for businesses using phone orders, agent-assisted sales, and MOTO transaction flows.</Tagline>
        <CTAButtonGroup>
