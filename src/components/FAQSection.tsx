...
const FAQSection: React.FC = () => {
  ...
  const faqs = [
    ...
    {
      question: 'Call Center & Telesales Businesses',
      answer: 'Merchants acquiring customers through call center operations, phone sales, and telesales campaigns. We specialize in recovering failed payments from call center transactions and agent-assisted sales flows.'
    },
    {
